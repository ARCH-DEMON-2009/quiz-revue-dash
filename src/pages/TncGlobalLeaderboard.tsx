            ...
            {rows.map((r) => (
              ...
              >
                ...
                <div className="relative h-10 w-10 shrink-0">
                  ...
                  <div className={`h-10 w-10 relative bg-background border-2 rounded-full overflow-hidden shrink-0 z-0 ${r.isAdmin ? getAdminAvatarBorder(true) : 'border-transparent'}`}>
                    <img 
